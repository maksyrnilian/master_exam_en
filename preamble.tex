...
\setlength{\columnseprule}{0.0  pt}  % set to 0.4pt for a dividing rule
...
\title{%
	\vspace*{2cm}
	{\Huge Master Diploma Examination}\thanks{Inspired by and partly reproduced from an analogous text in Polish by \textit{Krokosz et al.}}\\[1cm]
