...
% --- siunitx units setup ------------------------------------------------
\sisetup{per-mode=symbol-or-fraction} % 'slash' in ines; normal fraction in math-block
...
\usepackage[margin=3.5cm, marginparwidth=2.9cm]{geometry}  % page margins; width of \todo notes
...
\newcommand{\todoper}[1]{\todo[backgroundcolor=red!25,linecolor=red!55]{#1}}                           % red todo note for persisten comments
...
% \nicefrac{}{} for inline fraction (including diff. operators). \frac and \tfrac in display maths only.
...
% Em-dash as --- with no surrounding spaces.
% \todo with green background = rewritten and checked.