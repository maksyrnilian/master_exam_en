...
% --- comments --------------------------------------------------------
\usepackage[disable]{todonotes}                            % margin \todo notes used as revision flags; optional argument [disable] suppresses them for a clean, printable version (also change the margins then)
