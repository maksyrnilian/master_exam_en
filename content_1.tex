...
\section{Fundamental interactions; carriers and range of interactions, charges and characteristic energy scales}
    ...
    \todo[backgroundcolor=green!25,linecolor=green!55!black]{Rewritten: tightened the colour-exchange example and checked colour conservation (the original example was already consistent).}
