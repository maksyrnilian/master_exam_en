...
% NOTE: the \nabla\cdot dot products for the divergence terms were missing in
% the source (written \nabla\vec E); inserted here throughout the Maxwell
% blocks so the operators read as divergence and curl.
