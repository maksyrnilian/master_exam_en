...
\section{Maxwell's equations, the scalar and vector potentials of the electromagnetic field, the equations of the electromagnetic field in vacuum and in material media}
    ...
    \subsection{Maxwell's equations in vacuum}
        ...
        In vacuum, there are no bound charges or currents, and Maxwell's equations reduce to:

        \begin{equation}\label{eq:maxwell-vacuum}
            \begin{aligned}
                \nabla \cdot \vec{E}  & = \frac{\rho_{\text{f}}}{\epsilon_{0}}\\
                \nabla \cdot \vec{B}  & = 0\\
                \nabla \times \vec{E} & = -\frac{\partial \vec{B}}{\partial t}\\
                \nabla \times \vec{B} & = \mu_{0}\left(\vec{J_{\text{f}}} + \epsilon_{0}\frac{\partial\vec{E}}{\partial t}\right),
            \end{aligned}
        \end{equation}
